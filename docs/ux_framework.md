...
Operators may still use `/done`, `/cancel_email`, `/cancel_landing`, and legacy `/research` / natural phrases where implemented — see `telegram_chat_handler.py`.
...
| `services/telegram_post_task_markup.py` | Post-report inline row including **📥 Export to PDF**. |
