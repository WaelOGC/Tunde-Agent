...
**Upcoming phase (not implemented as autonomous loops today)** — product and safety gates remain in [self_improvement_rules.md](./self_improvement_rules.md) and [human_approval_gate.md](./human_approval_gate.md):
...
- [self_improvement_rules.md](./self_improvement_rules.md) — adaptive behavior limits  
