...
class TelegramService:
    ...
    def chat_id(self) -> str:
        ...
        """
        from tunde_agent.services.telegram_operator_chat import read_saved_operator_chat_id
    ...
    def send_markdown_v2(
        ...
        *,
        ...
        if not self._configured() or not text:
            return
        from tunde_agent.services.telegram_markdown_v2 import split_markdown_v2_message
    ...
    def send_html(
        ...
        *,
        ...
        if not self._configured() or not text:
            return
        from tunde_agent.services.telegram_markdown_v2 import split_html_message
