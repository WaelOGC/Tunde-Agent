...
| Design Agent | In Development | — | Phase 1 brand identity; **Business / Enterprise** tier — see `docs/08_tools/design_agent.md`, `design_agent_spec.md` |
...
3. **Design Agent** — implement **Phase 1 (brand identity)** per `docs/08_tools/design_agent_spec.md` (router, tool, `brand_identities` / DB routes, **Design Canvas** + wizard, exports); user-facing overview in `docs/08_tools/design_agent.md`.
