...
- **Single-node** deployment initially: API process, static SPA build, and Docker-managed databases on one VPS. Future **split** (separate DB host or worker host) is an evolution path described in [../05_project_roadmap/roadmap.md](../05_project_roadmap/roadmap.md), not a day-one requirement.
...
Promotion from **branch to production** should remain a **conscious operator action** until Phase 3 controls in [../05_project_roadmap/roadmap.md](../05_project_roadmap/roadmap.md) demand stricter gates.
...
- [../05_project_roadmap/roadmap.md](../05_project_roadmap/roadmap.md) — When multi-node or stronger isolation may appear.
