...
Technical blueprint for Tunde Agent: components, boundaries, data flow, and persistence. For capability detail see [features.md](./features.md). For how environments are run and deployed, see [infrastructure.md](./infrastructure.md). Phasing and risks sit in [../05_project_roadmap/roadmap.md](../05_project_roadmap/roadmap.md). Long-term safety for adaptive behavior is in [../05_project_roadmap/self_improvement_rules.md](../05_project_roadmap/self_improvement_rules.md).

**Protocols and persona:** [../01_telegram_bot/human_approval_gate.md](../01_telegram_bot/human_approval_gate.md) (sensitive actions), [../04_database_schema/data_retrieval_protocol.md](../04_database_schema/data_retrieval_protocol.md) (PostgreSQL, RLS, encryption), [../01_telegram_bot/persona_and_character.md](../01_telegram_bot/persona_and_character.md) (Tunde’s voice and boundaries), [captcha_handling_policy.md](./captcha_handling_policy.md), [security_and_legal_compliance.md](./security_and_legal_compliance.md) (privacy, law, Docker isolation). **Research missions — report language vs search locales:** [research_language_and_search_locales.md](./research_language_and_search_locales.md).
...
**Telegram UX:** [../01_telegram_bot/ux_framework.md](../01_telegram_bot/ux_framework.md) — nested inline menus (`u:` callbacks), `editMessageText` navigation, and handoff to free-text topic capture.
...
- Desktop or OS-level control (that is a later phase; see [../05_project_roadmap/roadmap.md](../05_project_roadmap/roadmap.md)).
...
Self-improvement and immutable security-sensitive components are constrained in [../05_project_roadmap/self_improvement_rules.md](../05_project_roadmap/self_improvement_rules.md).
