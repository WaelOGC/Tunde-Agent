...
Safety and ethics framework for long-term **adaptive** behavior: the agent may refine prompts, policies, and workflows in controlled ways, but **must not** subvert core security, authentication, or audit guarantees. Architecture context appears in [../02_web_app_backend/architecture.md](../02_web_app_backend/architecture.md). Product capabilities and human gates are in [../02_web_app_backend/features.md](../02_web_app_backend/features.md). Operational secrecy and deployment are in [../02_web_app_backend/infrastructure.md](../02_web_app_backend/infrastructure.md). Phasing and risk themes appear in [roadmap.md](./roadmap.md).
...
- Circumventing **human approval gates** defined for MVP features in [../02_web_app_backend/features.md](../02_web_app_backend/features.md).
...
The kernel may be **implemented** as libraries, services, and configuration inside the FastAPI stack described in [../02_web_app_backend/architecture.md](../02_web_app_backend/architecture.md); immutability is a **governance property**, not a specific file layout.
...
These align with the MVP gates in [../02_web_app_backend/features.md](../02_web_app_backend/features.md) and the risk register in [roadmap.md](./roadmap.md).
...
- **Phase 1** — Kernel is small but real: secrets outside the repo per [../02_web_app_backend/infrastructure.md](../02_web_app_backend/infrastructure.md); no agent-authored auth changes.
